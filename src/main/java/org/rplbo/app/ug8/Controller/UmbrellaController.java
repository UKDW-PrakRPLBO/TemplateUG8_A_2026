...
public class UmbrellaController implements Initializable {
    @FXML private TextField txtItem, txtAcquired, txtUsed; // Tambahkan txtUsed di FXML jika perlu
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tableInventory.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
            if (newVal != null) {
                ...
                txtItem.setDisable(true); // Item Name (Primary Key) tidak boleh diubah saat edit
            }
        });
        refreshTable();
    }
    ...
    private void handleAdd() {
        // ==============================================================================
        // TODO 1: LOGIKA TAMBAH DATA (GRUP A)
        // ==============================================================================
        // 1. Ambil nilai String dari field txtItem.
        // 2. Ambil nilai teks dari txtAcquired dan ubah menjadi Integer (Integer.parseInt).
        // 3. Buat objek InventoryItem baru:
        //    - itemName = nilai dari txtItem
        //    - acquired = nilai dari txtAcquired
        //    - used = 0 (karena barang baru ditambahkan, belum digunakan)
        //    - total_stock = nilai dari txtAcquired (sama dengan acquired awal)
        // 4. Panggil metode addItem() dari objek 'db' dan masukkan objek item tersebut.
        // 5. Panggil metode refreshTable() agar data baru muncul di tabel.
        // ==============================================================================
    ...
    private void handleSave() {
        // ==============================================================================
        // TODO 2: LOGIKA PERBARUI/UPDATE DATA (GRUP A)
        // ==============================================================================
        // 1. Pastikan ada item yang dipilih (cek apakah selectedItem tidak sama dengan null).
        // 2. Ambil nilai teks terbaru dari txtAcquired dan ubah menjadi Integer.
        // 3. HITUNG TOTAL STOCK BARU:
        //    Rumus: stock = acquired_baru - used_lama
        //    (Ambil 'used_lama' menggunakan metode getUsed() dari selectedItem).
